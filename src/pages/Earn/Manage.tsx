    ...
    <PageWrapper gap="lg" justify="center">
            ...
            <AutoColumn gap="md">
              ...
              <RowBetween style={{ marginBottom: "1rem" }}>
                <TYPE.white fontSize={14}>
                  {`TLP tokens are required. Once you've added liquidity to the ${currencyA?.symbol}-${currencyB?.symbol} pool you can stake your liquidity tokens on this page.`}
                </TYPE.white>
              </RowBetween>
              <ButtonPrimary
                padding="8px"
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
          ...
          <DataRow style={{ marginBottom: "1rem" }}>
            {stakingInfo && stakingInfo.active && (
              <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
                {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? "Deposit" : "Deposit TLP Tokens"}
              </ButtonPrimary>
            )}
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo("0") ? null : !stakingInfo?.active ? null : (
          <TYPE.main>{userLiquidityUnstaked.toSignificant(6)} TLP tokens available</TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
  );
